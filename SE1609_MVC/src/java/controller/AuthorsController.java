    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (service.equals("insertAuthors")) {
                ...
                if (submit == null) {
                    dispath(request, response, "/JSP/InsertAuthors.jsp");
                }
            ...
            if (service.equals("listAllAuthors")) {
                ...
                if (submit == null) {
                    ...
                    // select jsp
                    dispath(request, response, "/JSP/Display/DisplayAuthor.jsp");
                } else {
                    if (submit.equals("search")) {
                        String name = request.getParameter("pname");
                        Vector<authors> vector = dao.searchName(name);
                        // pre some other data
                        String titlePage = "Author manager";
                        String titleTable = "List of Author";
                        // set value for jsp by request.
            ...
            if (service.equals("deleteAuthor")) {
                String au_id1 = request.getParameter("au_id");
                if (dao.removeAuthor(au_id1) > 0) {
